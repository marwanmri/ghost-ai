...
Fetch projects server-side using the existing project data helper, pass a single Project[] array (with the isOwned flag) to the sidebar, and derive owned vs shared views there.
